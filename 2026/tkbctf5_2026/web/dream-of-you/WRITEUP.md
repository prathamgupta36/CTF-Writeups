...
The bug is a stored XSS caused by this order of operations in [`dream-of-you/app/app.py`](dream-of-you/app/app.py):
...
The bot code in [`dream-of-you/reader_bot/app.js`](dream-of-you/reader_bot/app.js) does:
...
I wrote the exploit helper in [`exploit.py`](exploit.py).
